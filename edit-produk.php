...
while ($customer_data = mysqli_fetch_array($result)) {
    ...
    $asal = $customer_data['asal'];
    $image = base64_encode($customer_data['gambar']);
        ...
        <section id="form">
            ...
            <div id="con-form" class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-md-7 img-thumbnail shadow-lg">
                        <div class="mb-2">
                            <img width="200px" height="200px" src='data:image/webp;base64,<?php echo ($image); ?>'>
                            <label><?= $nama; ?></label>
                            <a href="edit-foto-produk.php?id=<?= $customer_data['id'] ?>" class="btn btn-outline-success btn-sm mt-1">Change Pict</a>
                        </div>
                    </div>
                </div>
            <?php
                ...
                <div class="row justify-content-center mb-2">
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input id="asal" name="asal" type="text" class="form-control" value="<?= $asal; ?>" required>
                        </div>
                    </div>
                </div>
